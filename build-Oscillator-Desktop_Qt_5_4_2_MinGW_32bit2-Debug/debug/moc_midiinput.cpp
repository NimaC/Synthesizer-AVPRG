...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_drumstick__rt__MIDIInput_t, stringdata) + ofs \
...
void *drumstick::rt::MIDIInput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_drumstick__rt__MIDIInput.stringdata))
